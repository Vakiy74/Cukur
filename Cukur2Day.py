...
═════════════════➢""")
                                ...
                                if ppp in ['1','01']:
                                        ...
                                        plist.append('mmnnbb')
                                        plist.append('yuiopyuiop')
                                        plist.append('19951995')
                                        plist.append('20022002')
                                        plist.append('08520852')
                                        plist.append('00885522')
                                        plist.append('25802580')
                                        plist.append('22558800')
                                        plist.append('qqwwaass')
                                        plist.append('ppoollkk')
                                        plist.append('ppllookk')
                                        plist.append('070070')
                                        plist.append('1122334455')
                                        plist.append('11223344')
                                        plist.append('aliali')
                                        plist.append('20202021')
                                        plist.append('plmnplmn')
                                        plist.append('uuiioopp')
                                        plist.append('uiopuiop')
                                        plist.append('1234567890')
                                        plist.append('123456')
                                        plist.append('aaaa1111')
                                        plist.append('11112222')
                                        plist.append('332211')
                                        plist.append('112233')
                                        plist.append('vvvvbbbb')
